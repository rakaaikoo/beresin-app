        ...
        <div className="w-full max-w-md bg-purple-900/40 border border-white/10 backdrop-blur-md rounded-3xl p-6 sm:p-8 shadow-2xl shadow-black/50">
          ...
          <div className="flex bg-purple-950/60 p-1 rounded-2xl border border-white/10 mb-6">
            <button
              ...
              className={`flex-1 py-2 text-xs font-bold rounded-xl transition-all cursor-pointer ${authMode === "login"
            ...
            <button
              ...
              className={`flex-1 py-2 text-xs font-bold rounded-xl transition-all cursor-pointer ${authMode === "register"
                ? "bg-gradient-to-r from-rose-500 to-purple-600 text-white shadow-md"
                : "text-violet-400 hover:text-white"
                }`}
            >
        ...
        <div className="flex items-center justify-between gap-4 flex-wrap mb-4">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-full font-medium text-xs shadow-lg transition-all border ${pushStatus === "granted"
            ...
            {PRIORITY_ORDER.map((p) => {
              ...
              return (
                <button
                  ...
                  className={`flex-1 min-w-[110px] flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold border-2 transition-colors cursor-pointer ${active
              ...
              <div key={g.key} className="mb-6">
                ...
                {g.items.map((t) => {
                  ...
                  return (
                    <div
                      key={t.id}
                      className={`relative flex items-start gap-3 bg-purple-900/40 rounded-xl px-4 py-3 mb-3 border-l-4 ${meta.ring
                        } shadow-md shadow-black/20 ${t.done ? "opacity-40" : ""} ${overdue ? "outline outline-1 outline-dashed outline-rose-400/60" : ""
                        }`}
                    >
                      <button
                        onClick={() => toggleDone(t.id)}
                        aria-label="tandai selesai"
                        className={`w-6 h-6 shrink-0 mt-0.5 rounded-full border-2 flex items-center justify-center cursor-pointer ${meta.ring
